...
setwd("/Users/philippehabets/Dropbox/Endo/fMRI.transcriptomics/data/Bristol_study_ultradian_rhythm/z-stats")
...
##Fig4A
z <- readnii("cop16_thresh_zstat1.nii")
...
##Fig4B
zB<- readnii("cope13_thresh_zstat1.nii")
...
##Fig4A
f <- readnii("cop16_thresh_zstat1.nii")
...
L <- f.read.nifti.header("cop16_thresh_zstat1.nii")
...
##Fig4B
fB <- readnii("cope13_thresh_zstat1.nii")
maskB <- fB>0 
imgB <- img_data(maskB) 
imgB <- imgB*1 
...
#analyse img for 3Dinterpolation (img = effectmask as 3D array)
LB <- f.read.nifti.header("cope13_thresh_zstat1.nii")
...
setwd("/Users/philippehabets/Dropbox/Endo/fMRI.transcriptomics/data/Bristol_study_ultradian_rhythm/Output/")

dfGE <- readRDS("withinSampleNormalization/exprLimmaSRS.RDS") 
samples.coordinates <- readRDS("withinSampleNormalization/samples.coordinates.RDS")
...
probeInfo <- read.csv2("/Users/philippehabets/Dropbox/Endo/fMRI.transcriptomics/data/AHBA/reannotatedProbes_May2020/Probes_May2020.csv")
